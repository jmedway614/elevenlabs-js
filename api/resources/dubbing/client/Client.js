    ...
    dubAVideoOrAnAudioFile(request, requestOptions) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (request.csv_file != null) {
                yield _request.append("csv_file", request.csv_file);
            }
            if (request.foreground_audio_file != null) {
                yield _request.append("foreground_audio_file", request.foreground_audio_file);
            }
            if (request.background_audio_file != null) {
                yield _request.append("background_audio_file", request.background_audio_file);
            }
